        ...
        <div>
            ...
            <div id="service" className="service__webpageDesigne">
                <div className="service__webpageDesigne__left">
                    <p onClick={reactNativeData} className='service__webpageDesigne__left__circle webThree'><img src="images/jpy/web1.png" alt="" /></p>
                    <p onClick={webaPageData} className='service__webpageDesigne__left__circle webThree'><img src="images/jpy/web2.png" alt="" /></p>
                    <p onClick={applicationData} className='service__webpageDesigne__left__circle webThree'><img src="images/jpy/web3.png" alt="" /></p>
                    <p onClick={blockChainData} className='service__webpageDesigne__left__circle webThree'><img src="images/jpy/web4.png" alt="" /></p>
                    <p onClick={web3Data} className='service__webpageDesigne__left__circle webThree'><img src="images/jpy/web5.png" alt="" /></p>
                </div>
